...
\include{06-chapter-1} % intro
\include{12-chapter-7} % m2g
\include{08-chapter-3} % review
\include{09-chapter-4} % nonpar
\include{07-chapter-2} % heritability
% \include{11-chapter-6} %mgcx
\include{10-chapter-5} %graspy
\include{12-discussions}
...
\include{13-references}             % include reference chapter
